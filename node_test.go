...
func TestOptions(t *testing.T) {
	t.Run("AsStrings good", func(t *testing.T) {
		expect.Value(Some[any]([]any{"1", "2"}).AsStrings()).ToBe(t, Some[[]string]([]string{"1", "2"}))
		expect.Value(Some[any]([]string{"a", "b"}).AsStrings()).ToBe(t, Some[[]string]([]string{"a", "b"}))
	})

	t.Run("AsStrings bad", func(t *testing.T) {
		expect.Value(Some[any]([]any{"a", false}).AsStrings()).ToBe(t,
			Option[[]string]{Err: errors.New("[]interface {} is not []string")})
		expect.Value(Some[any]([]bool{true, false}).AsStrings()).ToBe(t,
			Option[[]string]{Err: errors.New("[]bool is not []string")})
		expect.Value(None[any]().AsStrings()).ToBe(t, None[[]string]())
	})

	t.Run("CoerceStrings good", func(t *testing.T) {
		expect.Value(Some[any]([]any{"1", "2", "3"}).CoerceStrings()).ToBe(t, Some[[]string]([]string{"1", "2", "3"}))
		expect.Value(Some[any]([]string{"a", "b"}).CoerceStrings()).ToBe(t, Some[[]string]([]string{"a", "b"}))
		expect.Value(Some[any]([]any{1, 2, 3}).CoerceStrings()).ToBe(t, Some[[]string]([]string{"1", "2", "3"}))
	...
	t.Run("CoerceStrings bad", func(t *testing.T) {
		expect.Value(Some[any]([]any{"a", false}).CoerceStrings()).ToBe(t,
			Option[[]string]{Err: errors.New("[]interface {} is not []string")})
	...
	t.Run("AsInts good", func(t *testing.T) {
		...
		expect.Value(Some[any]([]int{1, 2, 3}).AsInts()).ToBe(t, Some[[]int]([]int{1, 2, 3}))
	...
	t.Run("AsInts bad", func(t *testing.T) {
		...
		expect.Value(None[any]().AsInts()).ToBe(t, None[[]int]())
	})
	...
	t.Run("CoerceInts bad", func(t *testing.T) {
		expect.Value(Some[any]([]any{"a", false}).CoerceInts()).ToBe(t,
			Option[[]int]{Err: errors.New("[]interface {} is not []int")})
	...
	t.Run("AsFloat64s good", func(t *testing.T) {
		...
		expect.Value(Some[any]([]float64{1, 2, 3}).AsFloat64s()).ToBe(t, Some[[]float64]([]float64{1, 2, 3}))
	})
	...
	t.Run("AsFloat64s bad", func(t *testing.T) {
		...
		expect.Value(None[any]().AsFloat64s()).ToBe(t, None[[]float64]())
	})
